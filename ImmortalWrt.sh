...
function update_apt_source(){
	...
	#[ -n "$CHN_NET" ] && {
		...
		#	deb https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME main restricted universe multiverse
		#	deb https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME-security main restricted universe multiverse
		#	deb https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME-updates main restricted universe multiverse
		#	# deb https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME-proposed main restricted universe multiverse
		#	deb https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME-backports main restricted universe multiverse
		#	deb-src https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME main restricted universe multiverse
		#	deb-src https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME-security main restricted universe multiverse
		#	deb-src https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME-updates main restricted universe multiverse
		#	deb-src https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME-backports main restricted universe multiverse
		#	# deb-src https://mirror.sjtu.edu.cn/ubuntu/ $UBUNTU_CODENAME-proposed main restricted universe multiverse
		#EOF
	#}
